...
\begin{itemize}
	\item[$\bullet$] \textbf{Introducción:} Se hace una breve descripción del panorama genético y epidemiológico que engloban a la EA, el GB y el envejecimiento. Se ejemplifican las relaciones que existen entre estos atractores.
