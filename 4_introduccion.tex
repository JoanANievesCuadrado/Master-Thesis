...
El objetivo general planteado es estudiar de forma simultanea el panorama de expresión genética de la materia blanca del cerebro en condiciones homeostáticas, de enfermedad de Alzheimer (EA) y de glioblastoma (GB), con el fin de identificar atractores en este espacio y explorar como la progresión de la enfermedad da forma a las transiciones entre estos estados. Como objetivos específicos se definen los siguientes puntos:

\begin{itemize}
	\item Realizar un análisis de reducción dimensional que permita una adecuada representación gráfica de los datos y que, además, permita su interpretación.
	
	\item Identificar los ejes principales que definen la variación y la separación entre estos estados fisiológicos y patológicos.
	
	\item Identificar atractores en el espacio de expresión genética relacionados con estos estados en un marco de fitness celular.
	
	\item Representar las posiciones relativas de los atractores en el espacio de expresión genética, así como las principales transiciones que ocurren en el sistema.
	
	\item Identificar genes clave que subyacen a la separación de atractores.
\end{itemize}
